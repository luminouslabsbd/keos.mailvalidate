                    ...
                    <li className="nav-item">
                        <ul>
                            ...
                            <li className="menu nav-item">
                                <button type="button"
                                        className={`${currentMenu === 'kickBox_management' ? 'active' : ''} nav-link group w-full`}
                                        onClick={() => toggleMenu('kickBox_management')}>
                                    <div className="flex items-center">
                                        ...
                                        <span
                                            className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('KickBox Management')}</span>
                                    </div>

                                    <div
                                        className={currentMenu === 'kickBox_management' ? 'rotate-90' : 'rtl:rotate-180'}>
                                ...
                                <AnimateHeight duration={300}
                                               height={currentMenu === 'kickBox_management' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href={`${base_url}/admin/kickbox/create`}>{t('Add KickBox')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/kickbox/index`}>{t('All KickBox')}</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            <li className="menu nav-item">
                                <button type="button"
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <span
                                            className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Project Management')}</span>
                                    </div>
                                ...
                                <AnimateHeight duration={300}
                                    ...
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href={`${base_url}/admin/project/create`}>{t('Add Project')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/project/index`}>{t('All Project')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/project/email-list`}>{t('All Email List')}</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
