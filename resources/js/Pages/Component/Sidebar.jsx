                            ...
                            <li className="menu nav-item">
                                <button type="button"
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <span
                                            className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Domain Management')}</span>
                                    </div>
                                ...
                                <AnimateHeight duration={300}
                                    ...
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href={`${base_url}/admin/domain/create`}>{t('Add Domain')}</Link>
                                        </li>
                                        <li>
                                            <Link href={`${base_url}/admin/domain/domains`}>{t('All Domain')}</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
